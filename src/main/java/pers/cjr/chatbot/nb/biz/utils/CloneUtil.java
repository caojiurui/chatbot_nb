...
public class CloneUtil {
	 ...
	 */
	public static Object clone(Object obj, int level)
		...
		level--;
		if (obj instanceof Collection) {// 复制新的集合
			...
			if (c.equals(int[].class)) {
				int[] old = (int[]) obj;
				obj = (int[]) Arrays.copyOf(old, old.length);
			} else if (c.equals(short[].class)) {
				short[] old = (short[]) obj;
				obj = (short[]) Arrays.copyOf(old, old.length);
			} else if (c.equals(char[].class)) {
				char[] old = (char[]) obj;
				obj = (char[]) Arrays.copyOf(old, old.length);
			} else if (c.equals(float[].class)) {
				float[] old = (float[]) obj;
				obj = (float[]) Arrays.copyOf(old, old.length);
			} else if (c.equals(double[].class)) {
				double[] old = (double[]) obj;
				obj = (double[]) Arrays.copyOf(old, old.length);
			} else if (c.equals(long[].class)) {
				long[] old = (long[]) obj;
				obj = (long[]) Arrays.copyOf(old, old.length);
			} else if (c.equals(boolean[].class)) {
				boolean[] old = (boolean[]) obj;
				obj = (boolean[]) Arrays.copyOf(old, old.length);
			} else if (c.equals(byte[].class)) {
				byte[] old = (byte[]) obj;
				obj = (byte[]) Arrays.copyOf(old, old.length);
			} else {
				Object[] old = (Object[]) obj;
		...
		} else if (obj instanceof Map) {// 复制新的MAP
			...
			for (Field field : fields) {
				if (!Modifier.isFinal(field.getModifiers())) {// 仅复制非final字段
					...
					field.set(tmp, clone(field.get(obj), level));// 深度复制
				}
			}
			obj = tmp;
		}
	 ...
	 */
	public static Object deepCloneByIO(Object obj) throws IOException, ClassNotFoundException{
